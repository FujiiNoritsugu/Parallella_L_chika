...
Peripheral Summary:
  ...
  XPS project / EDK repository               : /home/fujii/parallella_hw_projects/parallella-hw/fpga/fujii_edk/MyProcessorIPLib
  logical library name                       : fujii_gpio_v1_00_a
  top name                                   : fujii_gpio
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
- XST synthesis file(s)
  ...
  devl/synthesis/fujii_gpio_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/fujii_gpio_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/fujii_gpio_v2_1_0.tcl
